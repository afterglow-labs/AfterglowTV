...
data class AppPalette(
    ...
    companion object {
        ...
        val SunsetAurora = AppPalette(
            ...
            description = "I love you Rachel! Deep mint-teal sunset with neon-peach glow, a coral-pink live marker, and warm cream bands.",
            surfaceDeep = Color(0xFF0E2622),
            surfaceBase = Color(0xFF143430),
            surfaceCool = Color(0xFF1C443D),
            surfaceAccent = Color(0xFF245449),
            accent = Color(0xFFFFA87A),
            accentLight = Color(0xFFFFC9A6),
            accentMuted = Color(0x66FFA87A),
            panelScrim = Color(0xD60E2622),
            osdScrim = Color(0xA60E2622),
            nowLine = Color(0xFFFF6F86),
            nowFill = Color(0x33FFA87A),
            live = Color(0xFFFF8A9E),
            pipPreviewOutline = Color(0xFFFFA87A),
            focusFill = Color(0x40FFA87A),
            textPrimary = Color(0xFFFFF7E9),
            textSecondary = Color(0xD9FCEADC),
            textTertiary = Color(0x99FCEADC),
            textDisabled = Color(0x66FCEADC),
            success = Color(0xFF8FE3C2),
            warning = Color(0xFFFFC9A6),
            info = Color(0xFFFF8A9E),
            divider = Color(0x22FFF7E9),
            outline = Color(0x66FFA87A),
            glowIntensity = 1f,
        )
        ...
        val Afterglow3 = AppPalette(
            ...
            description = "Black-violet surfaces with electric plum focus and magenta live edge.",
        ...
        val RachelsSunsetLight = AppPalette(
            ...
            description = "I love you Rachel! Bright peach-cream to mint daylight sunset with deep teal text and a coral-rose live marker.",
            surfaceDeep = Color(0xFFFFEDE0),
            surfaceBase = Color(0xFFFBDCCB),
            surfaceCool = Color(0xFFD7E2D2),
            surfaceAccent = Color(0xFFB6DBC7),
            accent = Color(0xFF0C5043),
            accentLight = Color(0xFFFF8A5C),
            accentMuted = Color(0x660C5043),
            panelScrim = Color(0xCC0E2A24),
            osdScrim = Color(0x990E2A24),
            nowLine = Color(0xFFBC2E48),
            nowFill = Color(0x330C5043),
            live = Color(0xFFBC2E48),
            pipPreviewOutline = Color(0xFF0C5043),
            focusFill = Color(0x400C5043),
            textPrimary = Color(0xFF11302B),
            textSecondary = Color(0xFF234038),
            textTertiary = Color(0xFF335048),
            textDisabled = Color(0x66234038),
            success = Color(0xFF0C5043),
            warning = Color(0xFFA8482A),
            info = Color(0xFFA53350),
            divider = Color(0x2211302B),
            outline = Color(0x660C5043),
            glowIntensity = 1f,
        )
        ...
        val MineralSlate = AppPalette(
            ...
            surfaceDeep = Color(0xFF13181D),
            surfaceBase = Color(0xFF212A32),
            surfaceCool = Color(0xFF303B45),
            surfaceAccent = Color(0xFF3D4A56),
            accent = Color(0xFFCD8B58),
            accentLight = Color(0xFFE7B68E),
            accentMuted = Color(0x66CD8B58),
        ...
        val GoldenSlate = AppPalette(
            ...
            surfaceCool = Color(0xFF455260),
            surfaceAccent = Color(0xFF505E6C),
