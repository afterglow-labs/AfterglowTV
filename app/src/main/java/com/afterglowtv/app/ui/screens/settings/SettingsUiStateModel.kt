...
data class SettingsUiState(
    ...
    val activeAdultLiveSource: ActiveLiveSource? = null,
    val activeAdultVodSource: ActiveLiveSource? = null,
    val isSyncing: Boolean = false,
    val syncProgress: String? = null,
    val syncingProviderName: String? = null,
    val isAddingProviderSource: Boolean = false,
    val addProviderSourceProgress: String? = null,
    val addProviderSourceError: String? = null,
